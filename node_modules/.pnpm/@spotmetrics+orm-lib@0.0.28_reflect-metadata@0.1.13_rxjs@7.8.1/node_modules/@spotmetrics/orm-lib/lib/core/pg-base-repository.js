...
exports.PgNestBaseRepository = void 0;
const common_1 = require("@nestjs/common");
const pg_format_1 = __importDefault(require("pg-format"));
const pg_nest_database_service_1 = require("./pg-nest-database.service");
let PgNestBaseRepository = class PgNestBaseRepository {
    constructor(pg) {
        this.pg = pg;
        this.CRUD = {
...
exports.PgNestBaseRepository = PgNestBaseRepository;
exports.PgNestBaseRepository = PgNestBaseRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [pg_nest_database_service_1.PgNestDatabaseService])
], PgNestBaseRepository);
